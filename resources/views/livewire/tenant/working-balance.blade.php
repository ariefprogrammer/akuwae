<div class="px-3 py-3">
    ...
    {{-- Saldo --}}
    <div class="app-card mb-3 text-center" style="background:linear-gradient(135deg,#dc3545,#b02a37);">
    ...
    @if($balance < 20000)
        <div class="alert alert-warning rounded-3 small">
            ⚠️ Saldo di bawah Rp 20.000. Tokomu tidak akan muncul di pencarian customer sampai top up.
        </div>
    @endif
    ...
    @if($topupRequests->isNotEmpty())
        <div class="fw-semibold small mb-2 text-muted">Permintaan Top Up</div>
        @foreach($topupRequests as $req)
            <div class="app-card mb-2 d-flex justify-content-between align-items-center">
                <div>
    ...
    {{-- Riwayat Mutasi --}}
    <div class="fw-semibold small mb-2 mt-3 text-muted">Riwayat Mutasi</div>
